...
Однако, стоит учесть, что файловая структура у нас изменилась. Теперь все шаблоны у нас лежат в директории ./template и собираються они в ./static/index.html
